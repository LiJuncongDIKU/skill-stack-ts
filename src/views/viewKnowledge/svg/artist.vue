<template>
  <div class="svg-wrap">
    <div class="inner" v-html="svgArtist" width="100%" height="100%"></div>
    <slot></slot>
  </div>
</template>
...
.svg-wrap {
  ...
  align-items: center;
  padding: 10px;
  background-image: linear-gradient(-135deg, #396fa6, #2c4258) !important;
  :deep(.inner) {
    ...
    svg {
      ...
      *{
        ...
        animation-timing-function: cubic-bezier(0.49, 0.78, 0.19, 1) !important;
      }
    }

    /***************************************************
 * Generated by SVG Artista on 1/4/2026, 5:59:17 PM
