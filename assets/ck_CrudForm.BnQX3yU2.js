...
\`\`\`
`,ea=[{content:Ge,name:"hook：useReactiveForm.ts"},{content:Xe,name:"组件使用例子",lang:"md"}],aa={class:"flex-wrap"},oa=C({__name:"CrudForm",setup(s){return(f,a)=>(h(),F("div",aa,[t(Ze,{class:"form"}),t(de,{class:"viewer",fileList:e(ea)},null,8,["fileList"])]))}}),ia=Z(oa,[["__scopeId","data-v-06fa04ec"]]);export{ia as default};
