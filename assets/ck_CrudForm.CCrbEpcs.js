...
\`\`\`
`,ao=[{content:ze,name:"hook：useReactiveForm.ts"},{content:oo,name:"组件使用例子",lang:"md"}],lo={class:"flex-wrap"},to=B({__name:"CrudForm",setup(s){return(_,o)=>(F(),E("div",lo,[n(eo,{class:"form"}),n(ie,{class:"viewer",fileList:e(ao)},null,8,["fileList"])]))}}),vo=ee(to,[["__scopeId","data-v-06fa04ec"]]);export{vo as default};
