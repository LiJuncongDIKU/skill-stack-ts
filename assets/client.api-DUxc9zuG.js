const n=`import axios, { type AxiosInstance, type AxiosRequestConfig } from 'axios';
...
useErrorInterceptor(publicAxios);`,e=`import { authAxios, publicAxios } from './request'
